...
public class OneCardManager : MonoBehaviour {
    ...
    public Text BuilderManaCostText;
    public Text RecruiterManaCostText;
    ...
    public bool CanBePlayedNow
    {
        ...
        set
        {
            canBePlayedNow = value;//CardFaceGlowImage.enabled = value;
        }
    }
    ...
    public void ReadCardFromAsset()
    {
        ...
        // 3) add mana cost
        BuilderManaCostText.text = cardAsset.BuilderManaCost.ToString();
        RecruiterManaCostText.text = cardAsset.RecruiterManaCost.ToString();
        // 4) add description
